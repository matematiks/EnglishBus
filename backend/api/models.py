...
class UserRegisterRequest(BaseModel):
    username: str
    password: str
    account_type: str = 'individual'  # 'individual', 'teacher', 'student'
    teacher_id: Optional[str] = None  # For students
...
class UserRoleUpdateRequest(BaseModel):
    account_type: str = Field(..., pattern="^(student|teacher|admin|individual)$")
    admin_id: int
...
class UserSettings(BaseModel):
    theme: Optional[str] = "system" # system, light, dark
    color_theme: Optional[str] = "brand" # brand, blue, orange, pink, green
    font_size: Optional[str] = "standard" # standard, large
    audio_speed: Optional[float] = 1.0
    auto_play: Optional[bool] = True
    show_images: Optional[bool] = True
    daily_goal: Optional[int] = 20
