...
- [ ] Verify images load: `curl http://localhost:8000/assets/A1_English/images/001.jpg`
- [ ] Verify audio loads: `curl http://localhost:8000/assets/A1_English/ing_audio/ing_001.mp3`
...
curl "http://localhost:8000/courses/1/units/status?user_id=1"
```
